...
API_VERSION = 43  # sky setup-slurm-ssh persistent credentials
...
# Minimum server API version required for sky setup-slurm-ssh.
MIN_SETUP_SLURM_SSH_API_VERSION = 43
